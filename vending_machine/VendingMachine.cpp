...
VendingMachine::VendingMachine(std::string machineId)
    : machineID(machineId), cashBalance(0.0), operational(true), productIdCounter(1), transactionIdCounter(1) {}
...
void VendingMachine::displayMachineInfo() const {
    ...
    std::cout<<"Status: "<< (operational? "Opetational" : "Not Available")<< std::endl;
