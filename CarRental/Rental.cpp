...
Rental::Rental(std::string rentalId, Car* car, Customer* customer, std::string startDate, int days):
        rentalId(rentalId), car(car), customer(customer), startDate(startDate), days(days) {
