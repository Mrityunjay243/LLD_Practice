...
Post::Post(std::string postId, std::string userId, std::string content, const std::vector<std::string>& tags, PostType type):
...
bool Post::removeVote(const std::string& getUserId){
