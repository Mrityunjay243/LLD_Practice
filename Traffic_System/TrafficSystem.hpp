...
class TrafficSystem{
    ...
    public: 
        ...
        Signal* addSignal(const std::string& intersectionId, int greenDuration = 30, int yellowDuration = 5, int redDuration = 30); 
        void removeSignal(const std::string& intersectionId, const std::string& singalId); 
        void updateSystem(int timeElapsed); 
        void setIntersectionStatus(const std::string& intersectionID, bool operational); 
        void syncronizeIntersection(const std::string& intersectionId); 
